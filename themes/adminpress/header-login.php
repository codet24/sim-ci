...
<head>
  ...
  <!-- Custom CSS -->
  <link href="<?php echo base_url('themes/adminpress/main/') ?>css/style.css" rel="stylesheet">
  <!-- You can change the theme colors from here -->
  <link href="<?php echo base_url('themes/adminpress/main/') ?>css/colors/blue.css" id="theme" rel="stylesheet">
