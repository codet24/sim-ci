    ...
    <!-- ============================================================== -->
    <section id="wrapper">
      <div class="login-register" style="background-image:url(<?php echo base_url('themes/adminpress/') ?>assets/images/background/login-register.jpg);">
...
<head>
  ...
  <!-- Custom CSS -->
  <link href="<?php echo base_url('themes/adminpress/horizontal/') ?>css/style.css" rel="stylesheet">
  <!-- You can change the theme colors from here -->
  <link href="<?php echo base_url('themes/adminpress/horizontal/') ?>css/colors/blue.css" id="theme" rel="stylesheet">
  ...
  <script src="<?php echo base_url('themes/adminpress/horizontal/') ?>js/jquery.slimscroll.js"></script>
  <!--Wave Effects -->
  <script src="<?php echo base_url('themes/adminpress/horizontal/') ?>js/waves.js"></script>
  <!--Menu sidebar -->
  <script src="<?php echo base_url('themes/adminpress/horizontal/') ?>js/sidebarmenu.js"></script>
  <!--stickey kit -->
