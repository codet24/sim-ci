...
<div class="form-group row<?php echo form_error('email') ? $errorClass : ''; ?>">
    <label class="col-md-2 required" for="email"><?php echo lang('bf_email'); ?></label>
    <div class="col-md-4">
        <input class="form-control <?php echo $controlClass; ?>" type="text" id="email" name="email" value="<?php echo set_value('email', isset($user) ? $user->email : ''); ?>" />
        <span class="help-inline"><?php echo form_error('email'); ?></span>
    </div>
</div>
<div class="form-group row<?php echo form_error('display_name') ? $errorClass : ''; ?>">
    <label class="col-md-2" for="display_name"><?php echo lang('bf_display_name'); ?></label>
    <div class="col-md-4">
        <input class="form-control <?php echo $controlClass; ?>" type="text" id="display_name" name="display_name" value="<?php echo set_value('display_name', isset($user) ? $user->display_name : ''); ?>" />
...
<div class="form-group row<?php echo form_error('username') ? $errorClass : ''; ?>">
    <label class="col-md-2 required" for="username"><?php echo lang('bf_username'); ?></label>
    <div class="col-md-4">
        <input class="form-control <?php echo $controlClass; ?>" type="text" id="username" name="username" value="<?php echo set_value('username', isset($user) ? $user->username : ''); ?>" />
        <span class="help-inline"><?php echo form_error('username'); ?></span>
    </div>
</div>
<?php endif; ?>
<div class="form-group row<?php echo form_error('password') ? $errorClass : ''; ?>">
    <label class="col-md-2<?php echo $registerClass; ?>" for="password"><?php echo lang('bf_password'); ?></label>
    <div class="col-md-4">
        <input class="form-control <?php echo $controlClass; ?>" type="password" id="password" name="password" value="" />
...
<div class="form-group row<?php echo form_error('pass_confirm') ? $errorClass : ''; ?>">
    <label class="col-md-2<?php echo $registerClass; ?>" for="pass_confirm"><?php echo lang('bf_password_confirm'); ?></label>
    <div class="col-md-4">
        <input class="form-control <?php echo $controlClass; ?>" type="password" id="pass_confirm" name="pass_confirm" value="" />
...
<div class="form-group row<?php echo form_error('language') ? $errorClass : ''; ?>">
    <label class="col-md-2 required" for="language"><?php echo lang('bf_language'); ?></label>
    <div class="col-md-4">
...
<div class="form-group row<?php echo form_error('timezones') ? $errorClass : ''; ?>">
    <label class="col-md-2 required" for="timezones"><?php echo lang('bf_timezone'); ?></label>
    <div class="col-md-4">
        <?php
        echo timezone_menu(
